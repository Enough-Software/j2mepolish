 ...
 */
public class SppRemoteService  implements BluetoothRemoteService {
	...
	public void start() throws BluetoothStateException {
		if (this.server == null) {
			this.server = new SppServer(this, SppServer.generateLocalUrl(this.uuid));
		}
		this.server.start();
	}
	 ...
	 * @param e
	 */
	public void handleError(SppServer sppServer, IOException e)
	{
		e.printStackTrace();

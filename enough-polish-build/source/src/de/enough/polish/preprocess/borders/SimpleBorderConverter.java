...
public class SimpleBorderConverter extends BorderConverter {
	...
	protected String createNewStatement(AttributesGroup border, Style style, StyleSheet styleSheet) throws BuildException {
		String topWidthStr = border.getValue("width-top");
		String bottomWidthStr = border.getValue("width-bottom");
		String leftWidthStr = border.getValue("width-left");
		String rightWidthStr = border.getValue("width-right");
		...
		if (topWidthStr == null && bottomWidthStr == null && leftWidthStr == null && rightWidthStr == null) {
			...
			this.width = border.getValue("width");
			if (this.width == null) {

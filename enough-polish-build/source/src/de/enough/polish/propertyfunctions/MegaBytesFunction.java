...
/**
 * <p>Converts memory values into megabytes.</p>
 *
 ...
 */
public class MegaBytesFunction extends BytesFunction {

	/**
	 * Creates a new function
	 */
	public MegaBytesFunction() {
		super();
	}
	...
	public String process(String input, String[] arguments, Environment env) {
		...
		String result = Double.toString( bytes / MEGA_BYTES );

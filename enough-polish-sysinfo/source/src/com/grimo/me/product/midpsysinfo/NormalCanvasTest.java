/*
 * Created on 11-Feb-2005 at 14:50:47.
 * 
...
/**
 * <p>A dynamic test that uses a normal canvas.</p>
 *
 ...
 */
public class NormalCanvasTest extends Canvas
implements DynamicTest
{
	private DynamicTestView view;
	
	public NormalCanvasTest() {
		super();
	}
	...
	public void addTestResults(InfoCollector collector ) {
		collector.addInfo( "CanvasWidth: ", "" + getWidth() );
		collector.addInfo( "CanvasHeight: ", "" + getHeight() );
	}

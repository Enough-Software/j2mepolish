...
public class Image extends Object
{
	...
	protected com.nttdocomo.ui.Image bitmap;
	private final boolean isMutable;
	
	private Image( com.nttdocomo.ui.Image bitmap, boolean isMutable) {
		this.bitmap = bitmap;
	...
	{
		com.nttdocomo.ui.Image bitmap = com.nttdocomo.ui.Image.createImage( width, height );
	...
	{
		return new Image( source.bitmap, source.isMutable );
	}
	...
	public static Image createImage( String name ) throws IOException
	{
        ...
        try {
        	...
        	throw new IOException("invalid image: " + name + ": " + e.toString() );
        }
	}
	...
	public static Image createImage(byte[] imageData, int imageOffset, int imageLength)
	{
		...
		try {
			com.nttdocomo.ui.Image image = MediaManager.getImage( imageData ).getImage();
	...
	public Graphics getGraphics()
	{
		...
		if (this.graphics == null) {
			...
			this.graphics.g = this.bitmap.getGraphics();
		}
	...
	{
		com.nttdocomo.ui.Image image = com.nttdocomo.ui.Image.createImage(width, height, rgb, 0);

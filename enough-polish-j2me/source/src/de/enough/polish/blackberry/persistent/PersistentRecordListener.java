 ...
 */
public interface PersistentRecordListener
{
	/**
	 ...
	 */
	void recordAdded( PersistentRecordStore recordStore, int recordId);
	 ...
	 */
	void recordChanged( PersistentRecordStore recordStore, int recordId);
	 ...
	 */
	void recordDeleted( PersistentRecordStore recordStore, int recordId);

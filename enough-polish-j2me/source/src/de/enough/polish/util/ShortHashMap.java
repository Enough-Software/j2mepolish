...
/**
 * <p>Provides the functionality of the J2SE java.util.HashMap for J2ME applications and uses short keys.</p>
 ...
 *    also uses only short keys for testing keys and and reference checks for testing values on
...
public class ShortHashMap
{
	 ...
	 */
	public ShortHashMap(int initialCapacity, int loadFactor) {
	...
	private static final class Element {
		...
		public Object value;
		public Element next;
		public Element ( short key, Object value ) {
			this.key = key;
			this.value = value;
		}
	}

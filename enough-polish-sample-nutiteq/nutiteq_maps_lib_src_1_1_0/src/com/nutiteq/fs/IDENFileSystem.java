 ...
 * @author CristiS
 */
public class IDENFileSystem implements FileSystem {
  ...
  public Vector getRoots() throws IOException {
    ...
    // list roots -- not possible, assume some defaults
    final String[] roots = { "a/", "b/", "c/", "e/" };
  ...
  public Vector listFiles(final String path) throws IOException {
    ...
    try {
      ...
      v.addElement("../");
      for (final Enumeration en = fconn.list("*", true); en.hasMoreElements();) {
